...
## ----- start of change -----------
# shdas@cisco.com : commenting out lines below
# 
...
# #}
#
# ## shdas@cisco.com : added these lines below:

set new_hist_list [lindex $hist_list 1]
foreach element $new_hist_list {
    if {[regexp $pattern $element]} {
        set time_rec [lindex $element 1]
        set location [lindex $element 7]
        if {$time_rec > $seconds_to_go_back} {
