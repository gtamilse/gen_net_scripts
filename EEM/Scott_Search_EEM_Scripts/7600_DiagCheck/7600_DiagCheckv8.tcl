...
if {$triggerFO == 1} {
    ...
    action_syslog msg $msg
    #sys_reqinfo_snmp_trapvar var vbinds oid 1.3.6.1.4.1.33333.3.0 string "$msg"
    sys_reqinfo_snmp_trap enterprise_oid 1.3.6.1.4.1.9.9.41.2 generic_trapnum 6 specific_trapnum 1 trap_oid 1.3.6.1.4.1.9.9.41.2.0.1 trap_var $msg
