::cisco::eem::event_register_syslog pattern "ROUTING-BGP-5-ADJCHANGE.*neighbor.*Down.*Interface flap.*VRF: 13979:21111" maxrun 240

# ::cisco::eem::event_register_syslog pattern "ROUTING-BGP-5-ADJCHANGE.*neighbor.*Down.*Interface flap.*VRF: 13979:32545" maxrun 240
...
action_syslog msg "EEM policy 7/11 bgp_bounce.tcl has started"

#################################################################################################
# These vars below should be set via the IOX global configuration for event manager environment:
# set _email_server 10.122.96.30
# set _domainname "cisco.com"
# set _email_from "eem@cisco.com"
...
if [catch {cli_exec $cli(fd) "vrf 13979:21111"} result] {
  error $result $errorInfo
}
