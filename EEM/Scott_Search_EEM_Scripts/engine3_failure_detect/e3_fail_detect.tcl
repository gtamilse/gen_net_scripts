...
#------------------------------------------------------------------
# Engine 3 LC Failure Detection Script and LC Shutdown
#
#
...
# detect the LC location.  The script will capture a BEFORE output of the
# 'admin show platform' output and save the data to the eem script output
# log file.  The script will then determine if a previous eem script run
# flag exists.  If the previous run flag does not exist the script will
# proceed with the LC shutdown.  After the LC shutdown the script will
# sleep for approximately 3 seconds.  The script then captures the AFTER
# output of the 'admin show platform' output and also save the output to
# the script log file.  The script will also generate its own custom
# syslog message.
#
#
#
...
# Sleep 3 seconds to let the LC status move to Down:
sleep 3
