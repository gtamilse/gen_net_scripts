::cisco::eem::event_register_syslog pattern "SSHD.*SECURITY-SSHD-6-INFO_SUCCESS.*Successfully authenticated user.*cisco" maxrun 600
...
foreach line [split $output "\n"] {
  if {[regexp "aracscbb" $line]} {
    set connected 1
  }
}

if {$connected == 1} {
  # User 'aracscbb' still connected.  Capture the outputs
  ...
  set msg "EEM policy xml_timeout_captures Exited user 'aracscbb' no longer logged in"
