::cisco::eem::event_register_syslog pattern "L2-BM-4-SELECTION.*Selection Login for.*is in LACP loopback" maxrun 180
...
##################################
# Storage location:
if {![info exists _LACP_LoopDetection]} {
...
set run_flag "$_LACP_LoopDetection_storage_location/run_flag"
...
set msg "EEM script LACP_LoopDetection triggered and collected a number of LACP Packet-Captures"
