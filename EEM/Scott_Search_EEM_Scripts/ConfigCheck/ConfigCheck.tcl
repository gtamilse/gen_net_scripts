::cisco::eem::event_register_syslog pattern "Configuration committed by user" maxrun 300

#
# NAME: ConfigCheck.tcl
#
#
# Example pattern:
# Configuration committed by user 'cisco'. Use 'show configuration commit changes 1000000758' to view the changes. 
# 
