=~=~=~=~=~=~=~=~=~=~=~= PuTTY log 2017.01.17 11:33:03 =~=~=~=~=~=~=~=~=~=~=~=
more harRP/0/RP1/CPU0:HUCAR6#more harddisk:// eem/CGSE_NoRoute_DataPath.tcl                                            term len 0
Tue Jan 17 11:33:15.249 EDT
RP/0/RP1/CPU0:HUCAR6#more harRP/0/RP1/CPU0:HUCAR6#more harddisk:/eem/CGSE_NoRoute_DataPath.tcl
Tue Jan 17 11:33:22.356 EDT
::cisco::eem::event_register_syslog occurs 2 period 120 pattern "PLATFORM-PLIM_SERVICES-7-GENERIC_ERROR : HA: XLP .*: Fail String: HA datapath test failed.*" maxrun 900
...
#   "PLATFORM-PLIM_SERVICES-7-GENERIC_ERROR : HA: XLP 1: Fail String: HA datapath test failed  0x0"
#
...
##########################################################################################
set pattern "PLATFORM-PLIM_SERVICES-7-GENERIC_ERROR : HA: XLP 1: Fail String: HA datapath test failed  0x0"
##################################
...
#set _CGSEnoRoute_storage_location "disk0:/eem"
set repeat 1 
set locations ""
...
# Step 1: Determine CGSE slot location
########################################################################
puts $FH "Step 1: Determine CGSE slot location\n"
