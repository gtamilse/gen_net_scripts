=~=~=~=~=~=~=~=~=~=~=~= PuTTY log 2017.01.17 11:34:20 =~=~=~=~=~=~=~=~=~=~=~=
dir harddisk:/eemmore harddisk:/eem/CGSE_NoRoute_DataPath.tcl                           m/CGSE_NoRoute_CoreToCore.tcl
Tue Jan 17 11:34:28.891 EDT
...
##########################################################################################
set pattern "plim_services_80ge[288]: HA: XLP 0: Fail String: Cores 0x400 not responding"
