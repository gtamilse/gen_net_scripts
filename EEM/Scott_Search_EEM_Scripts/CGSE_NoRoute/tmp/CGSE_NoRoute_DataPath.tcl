::cisco::eem::event_register_syslog occurs 2 period 120 pattern "PLATFORM-PLIM_SERVICES-7-GENERIC_ERROR : HA: XLP .*: Fail String: HA datapath test failed.*" maxrun 180
